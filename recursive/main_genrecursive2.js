...
const argv = require("yargs")
    .version(version)
    .usage("node main_genrecursive2.js -v <verification_key.json> -s starkinfo.json -o <recursive.circom> ")
    .alias("v", "verkey")
    .alias("s", "starkinfo")
    .alias("o", "output")
    .argv;
...
async function run() {
    ...
    const template = await fs.promises.readFile(path.join(__dirname, "recursive2.circom.ejs"), "utf8");
