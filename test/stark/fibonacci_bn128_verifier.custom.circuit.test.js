...
describe("Fibonacci bn128 Verifier circuit Tester", function () {
    ...
    before( async() => {
        ...
        circuit = await wasm_tester(path.join(__dirname, "../../", "tmp", "fibonacci.c12.custom.verifier.circom"), {O:1, verbose:true, include: ["circuits.bn128", "node_modules/circomlib/circuits"]});
    });
